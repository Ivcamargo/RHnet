...
- **Lead Capture System**: Commercial prospecting functionality integrated into the landing page for capturing potential customer information with automated email notifications to the sales team via SendGrid. Features form validation and admin-only management interfaces.
